...
public class DEBUG_CONSTRUCTOR_2 : MonoBehaviour
{
    ...
    IEnumerator STIMULATE()
    {
        ...
        while (true)
        {
            ...
            if (Input.GetMouseButtonDown(2))
            {
                ...
                #region PROCCESS , ( _PROPAGATE_ )
                PROCESS_HOLDER PROCESS_ref = PROCCESS(_info_BOARD_2D);



                bool[] silicon_state_1D__from_prev = new bool[PROCESS_ref.__silicon_1D__1D.Count];
                bool[] metal_state_1D__for_curr = new bool[PROCESS_ref.metal__silicon_1D__1D.Count];



                #region INITIALIZE  silicon_state_1D ..... metal_state_1D
                for (int i = 0; i < silicon_state_1D__from_prev.Length; i += 1)
                { silicon_state_1D__from_prev[i] = false; }

                for (int i = 0; i < metal_state_1D__for_curr.Length; i += 1)
                { metal_state_1D__for_curr[i] = false; }
                metal_state_1D__for_curr[0] = true;
                ...
                while (true)
                {
                    ...
                    PROPAGATE_HOLDER PROPAGATE_ref = PROPAGATE(
                        metal_state_1D__for_curr,
                        silicon_state_1D__from_prev,

                        PROCESS_ref.metal__silicon_1D__1D,

                        PROCESS_ref.silicon__metal_1D__1D,

                        PROCESS_ref.silicon_type_1D,
                        PROCESS_ref.__silicon_1D__1D,
                        PROCESS_ref.__silicon_1D__1D__1D
                    );


                    // metal_state_1D__for_curr = PROPAGATE_ref.metal_state_1D__curr_state;
                    silicon_state_1D__from_prev = PROPAGATE_ref.silicon_state_1D__curr_state;
                    ...
                    #region str // 
                    string str = "";
                    for (int i = 0; i < PROPAGATE_ref.metal_state_1D__curr_state.Length; i += 1)
                    {
                        if (PROPAGATE_ref.metal_state_1D__curr_state[i]) { str += '1'; }
                        else { str += '0'; }
                    }
                    ...
                    for (int i = 0; i < silicon_state_1D__from_prev.Length; i += 1)
                    {
                        if (silicon_state_1D__from_prev[i]) { str += '1'; }
                        else { str += '0'; }
                    }
                    Debug.Log(str);
                    #endregion
    ...
    #region PROCESS
    public PROCESS_HOLDER PROCCESS(int[,][] _info_BOARD_2D)
    {
        /*    
                           -1           0                     1  
        0 ... silicon...  empty   or  N-silicon         or   P-silicon
        ...
        */
        ...
        return new PROCESS_HOLDER()
        {
            metal__silicon_1D__1D = metal__silicon_1D__1D,

            silicon__metal_1D__1D = silicon__metal_1D__1D,

            silicon_type_1D = silicon_type_1D,
            __silicon_1D__1D = __silicon_1D__1D,
            __silicon_1D__1D__1D = __silicon_1D__1D__1D,
        };
        //
    }
    #endregion
    ...
    TODO
        silicon - previous_state..... silicon
                  ...
                  base_silicon cannot on from interface
    ...
    */
    ...
    #region PROPAGATE
    public PROPAGATE_HOLDER PROPAGATE(
    ...
    )
    {
        ...
        */
        ...
        return new PROPAGATE_HOLDER()
        {
            metal_state_1D__curr_state = metal_state_1D__curr_step,
            silicon_state_1D__curr_state = silicon_state_1D__curr_step
        };
    ...
    public class PROCESS_HOLDER
    {
        public List<List<int>> metal__silicon_1D__1D;


        public List<List<int>> silicon__metal_1D__1D;
        /* 
        A_silicon - B_silicon - A_silicon
        */
        public int[] silicon_type_1D;
        public List<List<int>> __silicon_1D__1D;
        public List<List<List<int>>> __silicon_1D__1D__1D;
