...
public static class _TOOL_
{
    ...
    */
    ...
    {     
        DEBUG_CONSTRUCTOR_2_2_0_._CONSTRUCTOR_.region_1D_Rs_  = new List<List<int[]>>();	
		DEBUG_CONSTRUCTOR_2_2_0_._CONSTRUCTOR_.region_1D_Ys_  = new List<List<int[]>>();
		DEBUG_CONSTRUCTOR_2_2_0_._CONSTRUCTOR_.region_1D_IRs_ = new List<List<int[]>>();
		DEBUG_CONSTRUCTOR_2_2_0_._CONSTRUCTOR_.region_1D_IYs_ = new List<List<int[]>>();
        
        for(int i0 = 0 ; i0 < region_1D_silicon.Count ; i0 += 1)
        {
            	 if(BOARD_2D_[region_1D_silicon[i0][0][0] , region_1D_silicon[i0][0][1]] == 0) { DEBUG_CONSTRUCTOR_2_2_0_._CONSTRUCTOR_.region_1D_Rs_ .Add(region_1D_silicon[i0]);}
            else if(BOARD_2D_[region_1D_silicon[i0][0][0] , region_1D_silicon[i0][0][1]] == 1) { DEBUG_CONSTRUCTOR_2_2_0_._CONSTRUCTOR_.region_1D_Ys_ .Add(region_1D_silicon[i0]);}
            else if(BOARD_2D_[region_1D_silicon[i0][0][0] , region_1D_silicon[i0][0][1]] == 2) { DEBUG_CONSTRUCTOR_2_2_0_._CONSTRUCTOR_.region_1D_IRs_.Add(region_1D_silicon[i0]);}
            else if(BOARD_2D_[region_1D_silicon[i0][0][0] , region_1D_silicon[i0][0][1]] == 3) { DEBUG_CONSTRUCTOR_2_2_0_._CONSTRUCTOR_.region_1D_IYs_.Add(region_1D_silicon[i0]);}      
        }
